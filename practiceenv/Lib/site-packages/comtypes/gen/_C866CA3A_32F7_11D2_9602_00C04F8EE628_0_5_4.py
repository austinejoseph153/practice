...
__all__ = [
    'ISpObjectWithToken', 'DISPID_SRGId', 'SPAR_Unknown',
    'DISPID_SPPConfidence', 'SSTTWildcard', 'ISpEventSink',
    'SPSUnknown', 'DISPID_SRCSetAdaptationData', 'DISPID_SASetState',
    'SDA_One_Trailing_Space', 'SVP_10', 'SAFT8kHz16BitStereo',
    'SAFT11kHz16BitStereo', 'DISPID_SRRRecoContext',
    'DISPID_SRCRequestedUIType', 'SPEI_SR_AUDIO_LEVEL',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SpeechRecoResult',
    'SPSSuppressWord', 'DISPID_SWFEBitsPerSample', 'SGRSTTWildcard',
    'DISPID_SLGetWords', 'SAFTText', 'SVP_2',
    'DISPID_SPEAudioSizeBytes', 'SDTReplacement', 'SRCS_Disabled',
    'SECFIgnoreCase', 'DISPID_SRSCurrentStreamNumber',
    '_SPAUDIOSTATE', 'DISPID_SRCESoundEnd', 'DISPID_SGRs_NewEnum',
    'SPDKL_LocalMachine', 'SPPS_Noun', 'SPAS_PAUSE',
    'DISPID_SLGetPronunciations', 'SRSActiveAlways',
    'DISPID_SRSetPropertyString', 'SAFT32kHz8BitStereo',
    'SVEStartInputStream', 'DISPID_SLWsCount', '_ISpeechVoiceEvents',
    'SGSExclusive', 'DISPID_SLPPhoneIds', 'SVSFDefault',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SPISaveToMemory',
    'eLEXTYPE_PRIVATE20', 'DISPID_SGRSRule', 'SP_VISEME_5',
    'SPVPRIORITY', 'DISPID_SPILanguageId', 'SPAUDIOSTATE',
    'DISPID_SPEsItem', 'ISpeechPhraseProperty', 'STCAll',
    'SAFT22kHz16BitStereo', 'SPEI_SR_BOOKMARK',
    'DISPID_SPEPronunciation', 'SVP_11',
    'DISPID_SpeechPhraseAlternate', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SLWPronunciations', 'SAFT44kHz16BitStereo',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SpeechAudio', 'SAFTADPCM_11kHzStereo', 'SGDSActive',
    'SPBO_NONE', 'DISPID_SRCCreateResultFromMemory', 'SRESoundEnd',
    'SPEI_SR_RETAINEDAUDIO', 'SpeechAudioVolume',
    'SAFT11kHz16BitMono', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SVAudioOutputStream', 'SpeechTokenShellFolder',
    'DISPID_SpeechObjectTokenCategory', 'SPPS_Modifier',
    'SREStreamStart', 'ISpeechWaveFormatEx',
    'ISpeechGrammarRuleStateTransitions', 'SPPS_NotOverriden',
    'DISPID_SMSALineId', 'DISPID_SRCEEnginePrivate', 'SpWaveFormatEx',
    'DISPID_SPAs_NewEnum', 'DISPID_SRCEAudioLevel', 'SRSInactive',
    'DISPID_SRCState', 'SPCT_SUB_DICTATION', 'SAFT32kHz8BitMono',
    'SPBO_PAUSE', 'SpeechPropertyResponseSpeed',
    'DISPIDSPTSI_ActiveOffset', 'ISpRecoGrammar2',
    'SRTExtendableParse', 'DISPID_SVResume', 'SAFTGSM610_11kHzMono',
    'DISPID_SABufferNotifySize', 'DISPID_SOTCategory', 'SPVPRI_OVER',
    'SITooQuiet', 'SPWF_SRENGINE', 'DISPID_SPARecoResult',
    'DISPID_SVVoice', 'SPWT_PRONUNCIATION', 'SVPNormal',
    'DISPID_SLPLangId', 'SPEI_RECO_STATE_CHANGE', 'SAFT22kHz8BitMono',
    'SPPS_Noncontent', 'SGRSTTEpsilon', 'SAFTCCITT_ALaw_8kHzMono',
    'SPWT_LEXICAL', 'ISpeechLexiconPronunciation',
    'DISPID_SASCurrentDevicePosition', 'SPEI_REQUEST_UI', 'SVP_19',
    'SPSEMANTICERRORINFO', 'DISPID_SASNonBlockingIO',
    'SPSERIALIZEDPHRASE', 'eLEXTYPE_PRIVATE18', 'DISPID_SOTCDefault',
    'DISPID_SGRInitialState', 'ISpRecognizer2',
    'DISPID_SRCRetainedAudioFormat', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SPIProperties', 'DISPID_SLPSymbolic',
    'SPFM_OPEN_READONLY', 'SpeechFormatType',
    'DISPID_SpeechGrammarRuleState', 'SpeechEmulationCompareFlags',
    'ISpPhrase', 'DISPID_SABIMinNotification', 'SVSFVoiceMask',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SRRSpeakAudio',
    'SPSHT_NotOverriden', 'SPINTERFERENCE_TOOFAST', 'SVF_Stressed',
    'DISPID_SPEAudioStreamOffset', 'SVEWordBoundary',
    'ISpeechRecoResultTimes', 'DISPID_SVSpeak',
    'DISPID_SPRNumberOfElements', 'SAFTDefault',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SBSSeek',
    'SpeechAllElements', 'DISPID_SPPs_NewEnum', 'SECFEmulateResult',
    'ISpeechPhraseInfoBuilder', 'SAFTCCITT_ALaw_44kHzMono',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPEI_SR_PRIVATE',
    'DISPID_SpeechVoice', 'SPEI_SENTENCE_BOUNDARY', 'ISpRecognizer',
    'SPSTREAMFORMATTYPE', 'SVP_5', 'SVP_8', 'SREStateChange',
    'ISpLexicon', 'SPPS_RESERVED1', 'SPPHRASEELEMENT',
    'DISPID_SPRsItem', 'ISpEventSource', 'SPPS_Function',
    'ISpeechLexicon', 'SRAInterpreter', 'SPEI_END_INPUT_STREAM',
    'DISPID_SDKDeleteValue', 'ISpRecoGrammar',
    'SPINTERFERENCE_TOOQUIET', 'SPRST_ACTIVE',
    'SpeechVoiceSpeakFlags', 'SVF_Emphasis', 'DISPID_SVSpeakStream',
    'SPEI_INTERFERENCE', 'SPEI_VOICE_CHANGE', 'SAFT48kHz8BitStereo',
    'DISPID_SOTCEnumerateTokens', 'SPFM_CREATE_ALWAYS',
    'SSSPTRelativeToEnd', 'ISpNotifyTranslator', 'SASStop',
    'DISPID_SPEDisplayAttributes', 'SpeechInterference',
    'SSSPTRelativeToStart', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SGRName', 'DISPID_SpeechLexicon',
    'DISPID_SpeechVoiceEvent', 'ISpeechGrammarRule',
    'SpeechTokenKeyFiles', 'SpeechVoiceSkipTypeSentence',
    'SDTLexicalForm', 'DISPID_SRCEEndStream',
    'SpeechStreamSeekPositionType', 'DISPID_SPERequiredConfidence',
    'DISPID_SOTRemove', 'SpeechEngineProperties', 'SpCustomStream',
    'SBOPause', 'eLEXTYPE_RESERVED4', 'DISPID_SVSLastBookmark',
    'ISpRecoResult', 'SP_VISEME_3', 'SPAS_RUN', 'SAFTADPCM_8kHzMono',
    'SAFTCCITT_ALaw_11kHzMono', 'SPEVENTENUM', 'SPGRAMMARSTATE',
    'SP_VISEME_14', 'SRTEmulated', 'IInternetSecurityManager',
    'SAFT24kHz16BitStereo', 'SSFMCreateForWrite', 'tagSTATSTG',
    'ISpeechGrammarRuleState', 'SPLO_STATIC', 'ISequentialStream',
    'SpeechCategoryRecoProfiles', 'SPPS_Unknown', 'ISpProperties',
    'LONG_PTR', 'DISPID_SRSNumberOfActiveRules',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPAS_STOP', 'SGRSTTDictation',
    'DISPID_SFSClose', 'DISPID_SREmulateRecognition', 'DISPID_SVSkip',
    'DISPID_SPRulesCount', 'DISPID_SpeechXMLRecoResult',
    'SPSHORTCUTPAIR', 'SWTDeleted', 'SECLowConfidence',
    'DISPID_SAFType', 'DISPID_SDKGetBinaryValue',
    'DISPID_SRCEventInterests', 'DISPID_SGRId', 'SECHighConfidence',
    'SECFDefault', 'SAFT24kHz16BitMono', 'ISpeechRecognizer',
    'ISpeechPhraseReplacement', 'SpeechCategoryAudioIn', 'SWTAdded',
    'DISPID_SRCERequestUI', 'DISPID_SPRulesItem',
    'SDA_Consume_Leading_Spaces', 'SAFTGSM610_22kHzMono',
    'IEnumSpObjectTokens', 'DISPID_SWFEExtraData',
    'eLEXTYPE_LETTERTOSOUND', 'SPBOOKMARKOPTIONS', 'SPPS_Verb',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SOTCSetId', 'DISPID_SVStatus',
    'DISPID_SRGReset', 'SASRun', 'SPINTERFERENCE',
    'eLEXTYPE_PRIVATE11', 'SGRSTTTextBuffer', 'SPEVENT',
    'SpeechCategoryAudioOut', 'SPRS_ACTIVE',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SOTId',
    'ISpRecoContext2', 'ISpeechPhraseElements', 'DISPIDSPRG',
    'SpNullPhoneConverter', 'SVSFParseMask',
    'ISpeechPhraseAlternates', 'SPPS_RESERVED4',
    'DISPID_SRAudioInputStream', 'SSFMOpenReadWrite',
    'ISpNotifySource', 'DISPID_SPIEngineId', 'DISPID_SVSRunningState',
    'SDKLCurrentUser', 'SVSFParseSsml', 'ISpRecoContext',
    'DISPID_SPIElements', 'SVP_1', 'ISpXMLRecoResult',
    'SpeechAudioState', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SPPValue', 'DISPID_SAEventHandle',
    'SpeechWordPronounceable', 'STSF_CommonAppData',
    'DISPID_SVEPhoneme', 'DISPID_SpeechVoiceStatus', 'SPCT_COMMAND',
    'DISPID_SPIReplacements', 'SpSharedRecognizer',
    'SAFT12kHz8BitStereo', 'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SpeechPhraseElement', 'ISpeechRecoResult',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SRGRules',
    'SAFT24kHz8BitMono', 'SPAUDIOOPTIONS', 'SPWORD',
    'DISPID_SRGSetTextSelection', 'DISPID_SpeechRecoResult2',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'WAVEFORMATEX',
    'SpStreamFormatConverter', 'ISpObjectToken', 'SPEI_HYPOTHESIS',
    'SPWORDTYPE', 'SAFT16kHz8BitStereo', 'SP_VISEME_9',
    'SP_VISEME_17', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SDKCreateKey', 'SFTSREngine', 'SPINTERFERENCE_NONE',
    'SVESentenceBoundary', 'SpeechCategoryPhoneConverters',
    'DISPID_SPEAudioTimeOffset', 'SREPrivate', 'SpMemoryStream',
    'DISPID_SRRPhraseInfo', 'SPPROPERTYINFO', 'DISPID_SLPsItem',
    'DISPID_SpeechRecoContext', 'SVPOver', 'SPFM_CREATE',
    'SPVPRI_NORMAL', 'ISpNotifySink', 'SAFT44kHz16BitMono',
    'SP_VISEME_10', 'SPEVENTSOURCEINFO', 'DISPID_SVPriority',
    'SLODynamic', 'DISPID_SPRsCount', 'SDTDisplayText',
    'SGLexicalNoSpecialChars', 'DISPID_SPIStartTime',
    'SDKLDefaultLocation', 'DISPID_SGRClear', 'eLEXTYPE_PRIVATE13',
    'DISPID_SpeechObjectTokens', 'SPWAVEFORMATTYPE',
    'DISPID_SMSSetData', 'SVP_17', 'SpeechVisemeType',
    'DISPID_SPEDisplayText', 'SPSHORTCUTPAIRLIST',
    'DISPID_SDKDeleteKey', 'SPTEXTSELECTIONINFO',
    'DISPID_SpeechPhraseReplacement', 'SAFT32kHz16BitMono',
    'SRADefaultToActive', 'SAFTADPCM_11kHzMono', 'eLEXTYPE_PRIVATE15',
    'eLEXTYPE_APP', 'SSFMCreate', 'SpeechAddRemoveWord',
    'DISPID_SVGetProfiles', 'DISPID_SWFEBlockAlign', 'SPEI_UNDEFINED',
    'SVP_18', 'SAFT48kHz16BitStereo', 'DISPID_SAFGetWaveFormatEx',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SpeechEngineConfidence',
    'SPINTERFERENCE_TOOLOUD', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SPSLMA', 'ISpPhraseAlt', 'DISPID_SVPause',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SABIBufferSize', 'SPGS_EXCLUSIVE', 'DISPID_SVEViseme',
    'DISPID_SpeechRecognizerStatus', 'SpInProcRecoContext',
    'SVSFIsFilename', 'DISPID_SPERetainedStreamOffset',
    'SpeechRecognizerState', 'ISpeechResourceLoader', 'SREBookmark',
    'SPSFunction', 'SPEI_RESERVED6', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SRCEStartStream', 'DISPID_SPCLangId',
    'SPSMF_SAPI_PROPERTIES', 'SAFTGSM610_8kHzMono',
    'DISPID_SpeechAudioFormat', 'ISpPhoneticAlphabetConverter',
    'DISPID_SRGDictationSetState', 'DISPID_SPRuleName',
    'DISPID_SRRSaveToMemory', 'DISPID_SPPsItem', 'SDKLCurrentConfig',
    'Speech_Max_Word_Length', 'DISPID_SRAudioInput',
    'DISPID_SRCEFalseRecognition', 'SpObjectToken',
    'DISPID_SVEAudioLevel', 'SVSFIsNotXML', 'SRERecognition',
    'DISPID_SVSLastResult', 'SP_VISEME_11', 'DISPID_SGRsAdd',
    'DISPID_SGRsCommit', 'SGSDisabled', 'DISPID_SPRuleId',
    'eLEXTYPE_PRIVATE5', 'SPAR_Low',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'eLEXTYPE_PRIVATE6', 'SPLO_DYNAMIC', 'SAFT16kHz16BitMono',
    'SP_VISEME_15', 'DISPID_SRCBookmark', 'SpeechGrammarWordType',
    'SVP_3', 'DISPID_SVIsUISupported', 'STCInprocServer',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SpeechVoiceCategoryTTSRate', 'IStream',
    'DISPID_SGRSTPropertyName', 'DISPID_SLPType', 'SPPARTOFSPEECH',
    'SECNormalConfidence', 'SP_VISEME_4', 'ISpeechVoiceStatus',
    'SpAudioFormat', 'ISpeechMemoryStream', 'SPRULESTATE',
    'SPVISEMES', 'DISPID_SVEWord', 'SPPHRASERULE',
    'SAFT16kHz8BitMono', 'DISPID_SGRSTPropertyId', 'SDTProperty',
    'eLEXTYPE_PRIVATE1', 'DISPID_SOTDisplayUI', 'DISPID_SGRSTsItem',
    'DISPID_SDKSetLongValue', 'DISPID_SLWsItem', 'SP_VISEME_16',
    'SGRSTTWord', 'SVSFNLPMask', 'DISPID_SpeechPhraseAlternates',
    'SGDSActiveUserDelimited', 'DISPID_SpeechPhraseProperties',
    'DISPID_SRCERecognition', 'ISpPhoneticAlphabetSelection',
    'eLEXTYPE_PRIVATE12', 'STCRemoteServer', 'SPFM_OPEN_READWRITE',
    'SPSHORTCUTTYPE', 'DISPID_SpeechBaseStream',
    '_ISpeechRecoContextEvents', 'DISPID_SpeechFileStream',
    'DISPID_SpeechObjectToken', 'DISPID_SPRText', 'DISPID_SOTSetId',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SPPsCount',
    'SpeechRuleState', 'SPPS_SuppressWord', 'SVEAudioLevel',
    'DISPID_SRIsShared', 'SVSFParseAutodetect',
    'DISPID_SOTRemoveStorageFileName', 'SAFTCCITT_uLaw_11kHzMono',
    'SRSInactiveWithPurge', 'DISPID_SVEventInterests',
    'SPADAPTATIONRELEVANCE', 'DISPID_SGRSTRule', 'DISPID_SVVolume',
    'SPPHRASEPROPERTY', '_RemotableHandle', 'SPCATEGORYTYPE',
    'SpeechAudioFormatGUIDText', 'DISPID_SRSSupportedLanguages',
    'SGDisplay', 'SPINTERFERENCE_NOSIGNAL', 'DISPID_SMSADeviceId',
    'SPEI_TTS_BOOKMARK', 'SpPhoneConverter', 'SRERecoOtherContext',
    'DISPID_SPRDisplayAttributes', 'DISPID_SRStatus',
    'DISPID_SGRsItem', 'SVSFPersistXML', 'DISPID_SGRSTText',
    'eLEXTYPE_PRIVATE7', 'SAFTADPCM_44kHzStereo', 'ISpGrammarBuilder',
    'DISPID_SpeechPhoneConverter', 'SpeechDictationTopicSpelling',
    'STSF_AppData', 'DISPID_SWFEChannels', 'ISpPhoneConverter',
    'SpeechAudioFormatType', 'DISPID_SBSFormat',
    'DISPID_SRGRecoContext', 'DISPID_SRCRetainedAudio',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SVEViseme', 'SRAONone',
    'SAFT22kHz8BitStereo', 'SPINTERFERENCE_LATENCY_WARNING',
    'SDTRule', 'SVP_16', 'SAFTCCITT_ALaw_8kHzStereo', 'SPAR_High',
    'DISPID_SPRuleChildren', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SLPs_NewEnum', 'SPINTERFERENCE_TOOSLOW',
    'SAFT24kHz8BitStereo', 'SECFNoSpecialChars', 'SPAS_CLOSED',
    'SAFT48kHz8BitMono', 'DISPID_SRRDiscardResultInfo', 'SVP_13',
    'DISPID_SVAudioOutput', 'SPAUDIOBUFFERINFO', 'eLEXTYPE_RESERVED9',
    'DISPID_SPIAudioStreamPosition',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SPRuleParent',
    'DISPID_SRGCmdSetRuleIdState', 'ISpShortcut', 'SINone',
    'SPSNotOverriden', 'DISPID_SRCRecognizer', 'SpMMAudioIn',
    'SPRST_NUM_STATES', 'DISPID_SOTMatchesAttributes', 'SREAllEvents',
    'SpShortcut', 'DISPID_SVSVisemeId',
    'SpeechPropertyHighConfidenceThreshold',
    'ISpeechPhraseProperties', 'SPSHT_EMAIL', 'DISPID_SRRTLength',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SAStatus',
    'DISPID_SVSInputWordLength', 'DISPID_SASCurrentSeekPosition',
    'SRTReSent', 'SVPAlert', 'SpeechStreamFileMode',
    'DISPID_SVSLastBookmarkId', 'SPGS_ENABLED', 'SRTAutopause',
    'DISPID_SpeechPhraseInfo', 'SVP_20', 'SpeechBookmarkOptions',
    'DISPID_SPIEnginePrivateData', 'SpeechAudioFormatGUIDWave',
    'DISPID_SRDisplayUI', 'SPSNoun', 'SP_VISEME_8', 'SDTAudio',
    'SpeechCategoryVoices', 'ISpeechRecoResultDispatch',
    'STSF_LocalAppData', 'DISPID_SVEStreamEnd', 'SPVOICESTATUS',
    'eLEXTYPE_RESERVED8', 'SP_VISEME_13', 'SAFTNoAssignedFormat',
    'DISPID_SRRGetXMLErrorInfo', 'SpeechPropertyAdaptationOn',
    'eLEXTYPE_PRIVATE9', 'DISPID_SRRAlternates',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'DISPID_SPIGetText',
    'ISpeechRecognizerStatus', 'SPWF_INPUT', 'DISPID_SPCIdToPhone',
    'DISPID_SPEActualConfidence', 'DISPID_SRSAudioStatus', 'SVP_6',
    'DISPID_SpeechGrammarRule', 'SPEI_MAX_SR',
    'DISPID_SRSClsidEngine', 'DISPID_SRGCmdSetRuleState',
    'SpMMAudioEnum', 'SDTAll', 'ISpeechObjectToken',
    'SAFTADPCM_22kHzMono', 'DISPID_SRGSetWordSequenceData',
    'SpeechLoadOption', 'DISPID_SRCEHypothesis',
    'eLEXTYPE_USER_SHORTCUT', 'SGRSTTRule', 'DISPID_SVAlertBoundary',
    'SITooSlow', 'SGLexical', 'SVEVoiceChange',
    'DISPID_SABIEventBias', 'DISPID_SRGIsPronounceable',
    'DISPID_SRCEPhraseStart', 'SPEI_ADAPTATION',
    'DISPID_SRCCmdMaxAlternates', 'SpObjectTokenCategory',
    'DISPID_SPPName', 'ISpeechGrammarRuleStateTransition',
    'SP_VISEME_21', 'SPAO_RETAIN_AUDIO', 'SPFM_NUM_MODES',
    'DISPID_SPPChildren', 'SpeechRecoProfileProperties',
    'SpeechLexiconType', 'SpeechGrammarRuleStateTransitionType',
    'SRAImport', 'SpMMAudioOut', 'SPEI_SOUND_END',
    'SPEI_PROPERTY_STRING_CHANGE', 'eLEXTYPE_RESERVED7', 'SLTUser',
    'SPLEXICONTYPE', 'SPWORDLIST', 'DISPID_SOTGetDescription',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPXMLRESULTOPTIONS', 'SPEI_MIN_SR',
    'DISPID_SRGetPropertyString', 'DISPID_SOTsCount',
    'SPRECOGNIZERSTATUS', 'DISPID_SpeechAudioStatus', 'SLOStatic',
    'SDA_No_Trailing_Space', 'SRSEIsSpeaking', 'DISPID_SRRecognizer',
    'DISPID_SpeechPhraseReplacements', 'SPSERIALIZEDRESULT',
    'SPEI_PHRASE_START', 'SVSFParseSapi', 'SRSEDone',
    'DISPID_SFSOpen', 'DISPID_SRSetPropertyNumber', 'eLEXTYPE_USER',
    'SREFalseRecognition', 'SAFTNonStandardFormat',
    'SAFT32kHz16BitStereo', 'DISPID_SOTDataKey', 'DISPIDSPTSI',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPCS_DISABLED',
    'DISPID_SRRTStreamTime', 'DISPID_SPCPhoneToId',
    'SAFT11kHz8BitMono', 'DISPID_SPPId', 'DISPID_SPPParent',
    'SECFIgnoreKanaType', 'SPEI_RESERVED3', 'DISPID_SLWWord',
    'SAFT44kHz8BitMono', 'SpPhoneticAlphabetConverter',
    'tagSPPROPERTYINFO', 'DISPID_SLGenerationId', 'SAFT12kHz8BitMono',
    'SAFTADPCM_8kHzStereo', 'SP_VISEME_0', 'SPPS_RESERVED3',
    'DISPID_SVSLastStreamNumberQueued', 'SVP_12',
    'DISPID_SpeechCustomStream', 'DISPID_SPPFirstElement',
    'DISPID_SGRSTsCount', 'DISPID_SPPNumberOfElements',
    'SpeechGrammarTagDictation', 'DISPID_SPAsItem',
    'eLEXTYPE_RESERVED10', 'SP_VISEME_6', 'SPBO_TIME_UNITS',
    'DISPID_SRGCmdLoadFromObject', 'SLTApp', 'eLEXTYPE_PRIVATE19',
    'SAFT48kHz16BitMono', 'DISPIDSPTSI_SelectionOffset',
    'ISpeechAudio', 'SRAORetainAudio', 'SVP_9', 'eLEXTYPE_PRIVATE2',
    'SPRECOCONTEXTSTATUS', 'SITooFast', 'DISPID_SRGState',
    'DISPID_SDKGetStringValue', 'SpeechPropertyResourceUsage',
    'SRCS_Enabled', 'ISpeechPhraseRules', 'DISPID_SRGDictationLoad',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SLPsCount',
    'DISPID_SDKOpenKey', 'DISPID_SDKEnumKeys', 'ISpeechPhraseInfo',
    'IInternetSecurityMgrSite', 'DISPID_SRGetPropertyNumber',
    'DISPID_SPEs_NewEnum', 'DISPID_SpeechGrammarRuleStateTransition',
    'SPCT_SLEEP', 'SpNotifyTranslator', 'SpeechDiscardType',
    'SVSFNLPSpeakPunc', 'SPPHRASE', 'SSTTDictation',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SDKEnumValues',
    'ISpRecoCategory', 'SWPUnknownWordUnpronounceable',
    'SAFTCCITT_uLaw_22kHzMono', 'SVEEndInputStream',
    'DISPID_SRRAudio', 'SAFT8kHz8BitMono', 'SpeechRunState',
    'DISPID_SGRsCommitAndSave', 'DISPID_SVSPhonemeId',
    'DISPID_SLWType', 'SpCompressedLexicon', 'SAFT8kHz16BitMono',
    'SpeechUserTraining', 'SFTInput', 'SVSFUnusedFlags',
    'SPEI_TTS_PRIVATE', 'DISPID_SGRSAddSpecialTransition',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SASState', 'SASPause',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPCONTEXTSTATE',
    'SPCT_SUB_COMMAND', 'SPLOADOPTIONS', 'STCLocalServer',
    'DISPID_SRGetFormat', 'SPPS_Interjection', 'DISPID_SRCVoice',
    'SpeechAudioProperties', 'SREInterference',
    'DISPID_SpeechMMSysAudio', 'DISPID_SRRAudioFormat',
    'tagSPTEXTSELECTIONINFO', 'SAFT22kHz16BitMono', 'SRADynamic',
    'SpeechVoicePriority', 'DISPID_SpeechPhraseRule',
    'SpeechTokenContext', 'SDTAlternates', 'ISpeechGrammarRules',
    'SPWT_DISPLAY', 'SPRECOSTATE', 'SP_VISEME_7', 'SpeechVoiceEvents',
    'DISPID_SpeechLexiconWord', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SpeechPhraseProperty', 'DISPID_SRRTimes', 'SpFileStream',
    'UINT_PTR', 'SGPronounciation', 'SPCT_DICTATION',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SPRules_NewEnum', 'SPEI_RESERVED5', 'SVEPrivate',
    'ISpeechXMLRecoResult', 'ISpeechAudioFormat',
    'Speech_StreamPos_RealTime', 'DISPID_SRState',
    'ISpeechPhoneConverter', 'SAFTADPCM_22kHzStereo',
    'DISPID_SMSAMMHandle', 'ISpeechPhraseRule', 'SPSHT_OTHER',
    'SpResourceManager', 'SAFTADPCM_44kHzMono',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SRGCommit',
    'DISPID_SLAddPronunciation', 'SP_VISEME_19',
    'DISPID_SPELexicalForm', 'DISPID_SVGetVoices',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SGRSTs_NewEnum',
    'SAFT11kHz8BitStereo', 'DISPID_SPAStartElementInResult',
    'DISPID_SAVolume', 'DISPID_SPPEngineConfidence', 'SPSModifier',
    'SPEI_WORD_BOUNDARY', 'DISPID_SRCVoicePurgeEvent',
    'SpTextSelectionInformation', 'DISPID_SPIAudioSizeBytes',
    'eLEXTYPE_PRIVATE8', 'DISPID_SADefaultFormat', 'SPSMF_UPS',
    'ISpeechVoice', 'SVP_4', 'SREAudioLevel', 'DISPID_SGRSTWeight',
    'SPFILEMODE', 'DISPID_SLWLangId', 'SPEI_RESERVED2',
    'SPRS_INACTIVE', 'ISpeechPhraseReplacements', 'SBONone',
    'DISPID_SGRAddResource', 'SpeechRecoEvents',
    'ISpeechLexiconPronunciations', 'DISPID_SPRuleConfidence',
    'SPDATAKEYLOCATION', 'SWPUnknownWordPronounceable',
    'SREPropertyStringChange', 'Speech_StreamPos_Asap',
    'DISPID_SRRGetXMLResult',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SVEStreamStart', 'DISPID_SAFGuid',
    'DISPID_SRRSetTextFeedback', 'DISPID_SRCResume',
    'SAFTGSM610_44kHzMono', 'DISPID_SPEAudioSizeTime',
    'DISPID_SWFEAvgBytesPerSec', 'SPPHRASEREPLACEMENT', 'SVSFIsXML',
    'DISPID_SpeechPhraseRules', 'DISPID_SRCPause', 'DISPID_SPEsCount',
    'SPEI_RESERVED1', 'SpeechTokenKeyUI', 'ISpStreamFormatConverter',
    'DISPID_SVSInputSentenceLength', 'DISPID_SVDisplayUI',
    'ISpStreamFormat', 'DISPID_SBSRead', 'eLEXTYPE_PRIVATE14',
    'STSF_FlagCreate', 'DISPID_SVSInputSentencePosition',
    'ISpeechRecoGrammar', 'DISPID_SRCEInterference',
    'eLEXTYPE_PRIVATE10', 'DISPID_SPAsCount',
    'SpeechRegistryUserRoot', 'SPGRAMMARWORDTYPE',
    'DISPID_SVESentenceBoundary', 'SpeechVisemeFeature',
    'DISPID_SOTCId', 'SPINTERFERENCE_NOISE', 'DISPID_SOTCGetDataKey',
    'SAFT8kHz8BitStereo', 'SDA_Two_Trailing_Spaces', 'SPVPRI_ALERT',
    'ISpeechFileStream', 'Speech_Max_Pron_Length', 'DISPID_SPACommit',
    'SPEI_VISEME', 'DISPID_SRRTTickCount', 'SREStreamEnd',
    'DISPID_SRGDictationUnload', 'ISpeechMMSysAudio',
    'SPEI_END_SR_STREAM', 'SPEI_START_SR_STREAM',
    'SpeechRecoContextState', 'DISPID_SGRsFindRule',
    'DISPID_SRProfile', 'SPWORDPRONUNCIATION', 'SRSActive',
    'SP_VISEME_12', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SPIGetDisplayAttributes', 'SPAUDIOSTATUS',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SPRs_NewEnum', 'SVP_21',
    'SVSFPurgeBeforeSpeak', 'DISPID_SVEVoiceChange',
    'DISPID_SGRSTType', 'Speech_Default_Weight', 'eLEXTYPE_PRIVATE3',
    'DISPID_SVRate', 'SDKLLocalMachine',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SGRAttributes',
    'SRAExport', 'SVP_0', 'DISPID_SWFESamplesPerSec',
    'DISPID_SGRSTNextState', 'DISPID_SGRSTPropertyValue',
    'DISPID_SLGetGenerationChange', 'SpLexicon',
    'DISPID_SWFEFormatTag', 'eWORDTYPE_DELETED', 'SP_VISEME_1',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SDKGetlongValue',
    'SPSVerb', 'SVSFlagsAsync', 'SpeechTokenValueCLSID',
    'DISPID_SPIRule', 'DISPID_SPRuleEngineConfidence',
    'SPGS_DISABLED', 'SpeechGrammarTagWildcard', 'SVF_None',
    'DISPID_SPRFirstElement', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SRCAudioInInterferenceStatus', 'SVP_15',
    'DISPID_SBSWrite', 'SAFTCCITT_uLaw_8kHzStereo',
    'SpeechRuleAttributes', 'DISPID_SRCEAdaptation',
    'SPSEMANTICFORMAT', 'ISpeechAudioBufferInfo',
    'DISPID_SOTGetAttribute', 'SAFT12kHz16BitStereo',
    'DISPID_SpeechLexiconProns', 'SAFTExtendedAudioFormat',
    'DISPID_SRIsUISupported', 'SPEI_PHONEME', 'SINoise', 'SGSEnabled',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SLPPartOfSpeech', 'SpeechSpecialTransitionType',
    'SpeechGrammarTagUnlimitedDictation', 'SpInprocRecognizer',
    'DISPID_SPEEngineConfidence', 'SGDSActiveWithAutoPause',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SRCreateRecoContext',
    'SAFTCCITT_uLaw_11kHzStereo', 'SVEBookmark',
    'DISPIDSPTSI_ActiveLength', 'ISpeechObjectTokenCategory',
    'SITooLoud', 'ISpAudio', 'DISPID_SpeechLexiconWords',
    'ISpeechLexiconWords', 'SDTPronunciation', 'SREPhraseStart',
    'SREAdaptation', 'SPEI_RECO_OTHER_CONTEXT', 'SPEI_MIN_TTS',
    '__MIDL_IWinTypes_0009', 'SPEI_MAX_TTS',
    'DISPID_SPRuleFirstElement', 'STCInprocHandler',
    'DISPID_SGRAddState', 'ISpeechRecoResult2', 'SPEI_SOUND_START',
    'SpeechWordType', 'SPBO_AHEAD', 'ISpeechLexiconWord',
    'DISPID_SGRsCount', 'eLEXTYPE_RESERVED6', 'SPRST_INACTIVE',
    'SpeechRetainedAudioOptions', 'ISpeechDataKey', 'SSTTTextBuffer',
    'ISpResourceManager', 'ISpMMSysAudio', 'SPRULE',
    'ISpeechObjectTokens', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SGRSTransitions', 'DISPID_SRGetRecognizers', 'SPXRO_SML',
    'eLEXTYPE_PRIVATE4', 'SPEI_START_INPUT_STREAM', 'SPPS_RESERVED2',
    'ISpeechAudioStatus', 'ISpVoice', 'SRATopLevel',
    'DISPID_SASFreeBufferSpace', 'ISpeechTextSelectionInformation',
    'SpeechTokenIdUserLexicon', 'SPRECORESULTTIMES', 'SRERequestUI',
    'SVP_14', 'ISpDataKey', 'SWPKnownWordPronounceable', 'SpVoice',
    'SpeechDisplayAttributes', 'SSFMOpenForRead',
    'ISpeechCustomStream', 'SpeechMicTraining', 'DISPID_SOTs_NewEnum',
    'SpeechPartOfSpeech', 'DISPID_SVWaitUntilDone',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SRCCreateGrammar',
    'DISPID_SPIGrammarId', 'SVP_7', 'DISPID_SpeechPhraseElements',
    'SASClosed', 'SpeechGrammarState', 'SAFT44kHz8BitStereo',
    'DISPID_SVEBookmark', 'SREHypothesis', 'SPAO_NONE',
    'ISpeechRecoContext', 'DISPID_SRCEPropertyNumberChange',
    'SRTSMLTimeout', 'IEnumString', 'SPSInterjection',
    'DISPID_SMSGetData', 'DISPID_SLRemovePronunciation',
    'SGDSInactive', 'SpeechCategoryRecognizers',
    'SPDKL_DefaultLocation', 'ISpRecognizer3',
    'DISPID_SVSInputWordPosition', 'SpUnCompressedLexicon',
    'SPPS_LMA', 'DISPID_SOTCreateInstance', 'SPXRO_Alternates_SML',
    'DISPID_SABufferInfo', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SGRSAddWordTransition', 'ISpeechPhraseAlternate',
    'DISPID_SLWs_NewEnum', 'SPSHT_Unknown', 'SPAR_Medium',
    'SRESoundStart', 'SECFIgnoreWidth', 'SPCS_ENABLED',
    'DISPID_SVSyncronousSpeakTimeout', 'SINoSignal',
    'ISpeechBaseStream', 'ISpSerializeState',
    'DISPID_SVGetAudioInputs', 'DISPID_SRCESoundStart',
    'SpeechCategoryAppLexicons', 'SP_VISEME_2', 'SAFT12kHz16BitMono',
    'DISPID_SVGetAudioOutputs', 'DISPID_SPAPhraseInfo',
    'DISPID_SpeechGrammarRules',
    'DISPID_SLAddPronunciationByPhoneIds', 'SpeechDataKeyLocation',
    'ISpStream', 'SpeechTokenKeyAttributes',
    'DISPID_SDKSetStringValue', 'DISPID_SpeechRecognizer',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SOTsItem',
    'SPDKL_CurrentUser', 'SREPropertyNumChange',
    'ISpeechPhraseElement', 'SP_VISEME_20', 'SPWORDPRONOUNCEABLE',
    'SP_VISEME_18', 'DISPID_SRRTOffsetFromStart', 'SPEI_RECOGNITION',
    'DISPID_SVEEnginePrivate', 'eWORDTYPE_ADDED',
    'DISPID_SDKSetBinaryValue', 'SRTStandard',
    'DISPID_SVSpeakCompleteEvent',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SOTIsUISupported',
    'SRARoot', 'SpStream', 'DISPID_SpeechMemoryStream', 'SVEPhoneme',
    'eLEXTYPE_PRIVATE17', 'SpSharedRecoContext',
    'DISPID_SPANumberOfElementsInResult',
    'DISPID_SpeechAudioBufferInfo', 'SPDKL_CurrentConfig',
    'SPBINARYGRAMMAR', 'eLEXTYPE_PRIVATE16', 'SAFT16kHz16BitStereo',
    'SpeechRecognitionType', 'DISPID_SpeechDataKey',
    'DISPID_SpeechPhraseBuilder', 'ISpObjectTokenCategory',
    'DISPID_SGRsDynamic', 'DISPID_SOTGetStorageFileName',
    'SpPhraseInfoBuilder', 'SAFTTrueSpeech_8kHz1BitMono',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SpeechRecoContextEvents',
    'SVEAllEvents', 'DISPID_SRCEBookmark', 'DISPID_SCSBaseStream',
    'DISPID_SPIAudioSizeTime'
]

_check_version('1.2.0', 1698191749.974762)
